...
import com.narij.gpslocationtest2.retrofit.APIClient;
import com.narij.gpslocationtest2.retrofit.APIInterface;
...
public class MainActivity extends AppCompatActivity {
    ...
    //    tv_address, tv_area, tv_locality, tv_city,
    TextView tv_latitude, tv_longitude, tv_stat;
...
//            String android_id = Settings.Secure.getString(getContext().getContentResolver(), Settings.android.provider.Settings.Secure.ANDROID_ID);
            TelephonyManager telephonyManager = (TelephonyManager) getSystemService(Context.TELEPHONY_SERVICE);
            String deviceId = telephonyManager.getDeviceId();
            Call<WebServiceMessage> call = apiInterface.saveLocation(deviceId, latitude + "", longitude + "");
            call.enqueue(new Callback<WebServiceMessage>() {
                ...
                public void onResponse(Call<WebServiceMessage> call, Response<WebServiceMessage> response) {
                    ...
                    adapter.locations.add(new Location(latitude, longitude));
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        mnuStart = menu.getItem(0);
        mnuStop = menu.getItem(1);
        return true;
    }
